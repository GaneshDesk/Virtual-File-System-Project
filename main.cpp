...
{
	printf("\n--------------------------------------------------------------");
	printf("\n Command: ls : Used to list of all files in system.");
	printf("\n Syntax: ls [FILE_NAME] [PERMISSION]");
	printf("\n PERMISSION: 1-read, 2-write, 3-read & write.");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: create : Used to create new file in system.");
	printf("\n Syntax: create [FILE_NAME] [PERMISSION]");
	printf("\n PERMISSION: 1-read, 2-write, 3-read & write.");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: rm : Used to remove files in system.");
	printf("\n Syntax: rm [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: open : Used to open file in system.");
	printf("\n Syntax: open [FILE_NAME] [MODE]");
	printf("\n MODE: 1-read, 2-write, 3-read & write.");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: read : Used to read existing file in system.");
	printf("\n Syntax: read [FILE_NAME] [SIZE]");
	printf("\n SIZE: Number of character to read from file.");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: write : Used to write data in file.");
	printf("\n Syntax: write [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: truncate : Used to delete data of files in system.");
	printf("\n Syntax: truncate [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: lseek : Used to reposition read/write file offset .");
	printf("\n Syntax: lseek [FILE_NAME] [SIZE] [FROM] ");
	printf("\n SIZE: Number of character to seek.");
	printf("\n FROM: posion from which seek a characters. ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: stat : Used to display detail info of files in system.");
	printf("\n Syntax: stat [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: close : Used to close file in system.");
	printf("\n Syntax: close [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: closeall : Used to close all open files in system.");
	printf("\n Syntax: closeall [FILE_NAME] ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: clear : Used to clear/clean screen/terminal.");
	printf("\n Syntax: clear ");
	printf("\n--------------------------------------------------------------");
	printf("\n Command: exit : Used to stop the execution.");
	printf("\n Syntax: exit ");
	printf("\n--------------------------------------------------------------");
